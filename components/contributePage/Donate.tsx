...
const Donate = () => {
  return (
    <section className="min-h-[60vh] bg-[#35e1ff] px-[1.5rem] border-bblack border-b[1.5px] grid place-items-center py-[4rem] border-y-black border-y-[1.5px] relative">
      <Image
        src={heart}
        alt="heart"
        width={100}
      ...
      <div className="flex flex-col items-center justify-center gap-[2.5rem]">
        <Reveal y={150} width="100%">
          <h1 className=" font-louize-Bold text-black text-[1.2rem] text-center uppercase lg:mx-auto lg:w-[50%]">
        ...
        <Link
          ...
          className="border-[#000000] mx-auto border-2 text-[1.2rem] text-[#000000] px-[1.5rem] rounded-full md:hover:bg-[#ffde24] md:hover:border-[#ffde24] duration-300 lg:text-[2rem] py-[0.5rem]"
        >
          GIVE TO A TEENAGER
        </Link>
        {/* </Reveal> */}
